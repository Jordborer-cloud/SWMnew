...
class CapitalMarketsCalculator:
    ...
    def __init__(self):
        ...
        self.load_capital_markets_data()
        
        self.available_assets = list(self.asset_data_real.keys())
    ...
    def load_capital_markets_data(self):
        ...
        try:
            ...
            df = pd.read_excel(excel_path, sheet_name='Capital Market')
            ...
            self.asset_data_nominal = {
                'Global Equity': {'Expected Return': 0.0800, 'Volatility': 0.165},
                'Global Property': {'Expected Return': 0.0400, 'Volatility': 0.100},
                'Global Bonds': {'Expected Return': 0.0450, 'Volatility': 0.005},
                'Global Private Real Estate': {'Expected Return': 0.1200, 'Volatility': 0.100},
                'Global Private Debt': {'Expected Return': 0.0900, 'Volatility': 0.080},
                'Global Diversified Alternatives': {'Expected Return': 0.1100, 'Volatility': 0.120},
                'Global VC': {'Expected Return': 0.1300, 'Volatility': 0.250},
                'Guaranteed Return USD': {'Expected Return': 0.0625, 'Volatility': 0.020},
                'Guaranteed Investment USD': {'Expected Return': 0.0700, 'Volatility': 0.020},
                'Autocall Capital Protected USD': {'Expected Return': 0.0800, 'Volatility': 0.025},
                'USD Cash': {'Expected Return': 0.0450, 'Volatility': 0.005}
            }
            
            self.asset_data_real = {
                'Global Equity': {'Expected Return': 0.0500, 'Volatility': 0.165},
                'Global Property': {'Expected Return': 0.0100, 'Volatility': 0.100},
                'Global Bonds': {'Expected Return': 0.0150, 'Volatility': 0.005},
                'Global Private Real Estate': {'Expected Return': 0.0900, 'Volatility': 0.100},
                'Global Private Debt': {'Expected Return': 0.0600, 'Volatility': 0.080},
                'Global Diversified Alternatives': {'Expected Return': 0.0800, 'Volatility': 0.120},
                'Global VC': {'Expected Return': 0.1000, 'Volatility': 0.250},
                'Guaranteed Return USD': {'Expected Return': 0.0325, 'Volatility': 0.020},
                'Guaranteed Investment USD': {'Expected Return': 0.0400, 'Volatility': 0.020},
                'Autocall Capital Protected USD': {'Expected Return': 0.0500, 'Volatility': 0.025},
                'USD Cash': {'Expected Return': 0.0150, 'Volatility': 0.005}
            }
    ...
    def run_calculator(self):
        ...
        try:
            ...
            # Calculate weighted expected return and variance
            for asset, weight in self.allocation.items():
            ...
            print(f"   📊 Sharpe Ratio: {(expected_return / portfolio_volatility):.2f}")
    ...
    def create_comprehensive_charts(self, final_values, yearly_values, mean_value, median_value, p10_value, p90_value):
        ...
        try:
            ...
            ax8.axvline(mean_multiple, color='red', linestyle='--', linewidth=2, 
